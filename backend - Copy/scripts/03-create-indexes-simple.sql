...
CREATE INDEX idx_click_history_user_id ON click_history(user_id);
CREATE INDEX idx_click_history_created_at ON click_history(created_at);

-- Indexes for help table
CREATE INDEX idx_help_user_id ON help(user_id);
...
CREATE INDEX idx_subscription_types_price ON subscription_types(price);

-- Indexes for payment_types table
CREATE INDEX idx_payment_types_is_active ON payment_types(is_active);
...
CREATE INDEX idx_menus_role_id ON menus(role_id);
